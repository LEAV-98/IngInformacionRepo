...
<body>
	...
	?>
		<div class="container  mt-1 border border-secondary mb-1">
				...
				<div class="col-md-8">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<h5>Correo</h5> <?php echo $row['email']  ?><br><br>
							<h5>Teléfono</h5> <?php echo $row['phone_no']  ?><br><br>
						</div>
						<div class="col-md-6">
							<h5>Dirección</h5> <?php echo $row['permanent_address']  ?><br><br>
							<!-- <h5>CNIC:</h5> <?php echo $row['cnic']  ?><br><br> -->
							<h5>Código</h5> <?php echo $row['teacher_id']  ?><br><br>
						</div>
					</div>
				</div>
				<hr>
			...
			<div class="row pt-3">
				<div class="col-md-4">
					<h5>Estado</h5> <?php echo $row['teacher_status']  ?>
				</div>
				<div class="col-md-4">
					<h5>Sexo</h5> <?php echo $row['gender']  ?>
				</div>
				<div class="col-md-4">
					<h5>Fecha de Nacimiento</h5> <?php echo $row['dob']  ?>
				</div>
			</div>
			<div class="row pt-3">
				<!-- <div class="col-md-4">
