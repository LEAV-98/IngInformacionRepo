...
if (isset($_POST['btn_save'])) {
	...
	*/
	...
	$query = "Insert into teacher_info(first_name,last_name,email,phone_no,profile_image,teacher_status,dob,gender,permanent_address)values('$first_name','$last_name','$email','$phone_no','$profile_image','$teacher_status','$dob','$gender','$permanent_address')";
